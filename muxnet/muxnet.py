...
from muxnet.conv2d_helpers import select_conv2d
...
class GenMUXNet(nn.Module):
    ...
    def forward(self, x):
        ...
        latent = deepcopy(self.classifier(x).detach())
        return self.classifier(x), (latent, latent_in) # ROEE ADDED
